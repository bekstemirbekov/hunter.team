...
export default function AddProduct() {
    ...
    const handleSave = () => {
        if(!values.image)values.image = 'https://img1.badfon.ru/original/1536x2048/9/18/bmw-kapot-kapli-foto-makro.jpg'
      ...
      >
        ...
        <div style={{display: 'flex', justifyContent: 'space-around', color: 'black'}}>
            ...
            <div style={{
                ...
                <Button style={{backgroundColor: 'green'}} onClick={handleSave} variant='contained' > 
                    выставить
                </Button>
            </div>
        </div>
